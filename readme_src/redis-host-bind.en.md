...
Depending on your requirements, you can switch Redis's accessibility mode using a single `REDIS_HOST_BIND` variable in the `.env` file:

1. **Local mode**
    * **Configuration:** `REDIS_HOST_BIND=127.0.0.1`
...
2. **Public mode**
    * **Configuration:** `REDIS_HOST_BIND=0.0.0.0`
